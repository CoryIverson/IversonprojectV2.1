...
Roadmap & Goals: 
>By the end of the december ; fix carousels, glossary issues and expand the narrative for Story 2,3,4 to flow together a bit more nicely. 
...
***Note:** Any feed back is loved ; there are some known issues with flow. The "Physical vs Digital" section in Story 4 was meant to have a different format, the current version is a placeholder.Typos and more have not been gone through either with a fine tooth comb ; but if you see any please feel free to point them out. Literally ANY feed back is appreciated. 
